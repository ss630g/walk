...
void render(void)
{
    ...
    ggprint8b(&r, 16, 0x000ff, "press P to pause");
    if (gl.movie) {
        screenCapture();
    }
    //const char* a;
    ...
    if (gl.state == STATE_STARTUP) {
        ...
        ggprint8b(&r, 16, 0, stuff());
        ggprint8b(&r, 16, 0, "X   Play");
    }
    if (gl.state == STATE_PAUSE) {
        ...
        r.left = gl.xres/2;
        r.center = 1;
        ggprint16(&r, 16, 0xffffffff, "PAUSED");
        r.left = gl.xres/2 - 100;
        r.center = 0;
        ggprint8b(&r, 16, 0xffffffff, "W   Walk cycle");
        ggprint8b(&r, 16, 0xffffffff, stuff());
        ggprint8b(&r, 16, 0xffffffff, "X   Play");
    }
}
